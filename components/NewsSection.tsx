  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-2">農業相關政策、技術與市場動態</p>
      </div>

      {/* News Filter */}
      <div className="bg-white rounded-lg shadow-md p-4">
        <div className="flex flex-wrap gap-2">
          <button className="px-4 py-2 rounded-lg bg-gray-800 text-white font-medium">
            全部
          </button>
          <button className="px-4 py-2 rounded-lg bg-blue-100 text-blue-700 hover:bg-blue-200">
            政策
          </button>
          <button className="px-4 py-2 rounded-lg bg-green-100 text-green-700 hover:bg-green-200">
            技術
          </button>
          <button className="px-4 py-2 rounded-lg bg-purple-100 text-purple-700 hover:bg-purple-200">
            市場
          </button>
          <button className="px-4 py-2 rounded-lg bg-orange-100 text-orange-700 hover:bg-orange-200">
            活動
          </button>
        </div>
      </div>
